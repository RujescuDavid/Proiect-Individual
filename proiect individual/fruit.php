...
<body>
  ...
  <section class="fruit_section layout_padding-top">
    <div class="container">
      <h2 class="custom_heading">Fructe Proaspete Zilnic</h2>
      <p class="custom_heading-text">
        Prosperitate în fiecare mușcătură
      </p>
    ...
    <section class="service_section layout_padding ">
      <div class="container">
        <h2 class="custom_heading">În cadrul gamei noastre variate, veți descoperi următoarele produse.</h2>
        <div class=" layout_padding2">
          <div class="card-deck">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title">Fucte Citrice</h5>
                <p class="card-text">
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
      ...
      echo '<input type="hidden" name="product_id" value="' . $row['id_produs'] . '">';
      echo '<button type="submit" name="buy" class="custom_dark-btn">Cumpără</button>';
      echo '</form>';
      echo '</div>';
      echo '</div>';
